;!(function(win,doc){  
    ...
    Ripple.prototype = {
        ...
        addEvent : function(){
            ...
            for(var i = 0; i < this.elements.length; i++){
				if (!this.elements[i].getAttribute("data-ripple")) {
					this.elements[i].setAttribute("data-ripple","ripple");
				}
    ...
    Ripple.prototype.init = function(){
        ...
        var _this = this;
        //初始化
        if (_this.option.dom&&_this.option.dom!="") {
        	_this.elements = doc.querySelectorAll(_this.option.dom);
        }else{
